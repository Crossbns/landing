...
<body>
    ...
    <form class="form" action="/user" method="POST" id="form">
    ...
    @csrf
        ...
        <div class="form-cont">
            ...
            <div>
                <input type="text" class="form-input" placeholder="Nombre:" name="Nombre" id="user" required>
            </div>
            ...
            <div>
                <input type="text" class="form-input" placeholder="Contraseña:" name="Contraseña" id="password" required>
            </div>
